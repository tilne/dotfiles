...
let s:colors = {
      ...
      \ "green": get(s:overrides, "green", { "gui": "#859c72", "cterm": "114", "cterm16": "2" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#7c87cf", "cterm": "39", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#894FC4", "cterm": "170", "cterm16": "5" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#8FBCBB", "cterm": "38", "cterm16": "6" }),
