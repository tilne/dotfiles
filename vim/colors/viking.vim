...
" Vim Color File
" Name:       viking.vim
" Based On:   https://github.com/joshdick/viking.vim/
...
" < https://github.com/joshdick/viking.vim/blob/master/README.md >
" for more information.)
if !exists("g:viking_termcolors")
  let g:viking_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:viking_terminal_italics")
  let g:viking_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `viking#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from viking#extend_highlight
  ...
  if g:viking_terminal_italics == 0
...
function! viking#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! viking#extend_highlight(group, style)
...
if get(g:, 'viking_hide_endofbuffer', 0)
...
call s:h("gitcommitHeader", {"fg": s:darkgreen })
call s:h("gitcommitUntrackedFile", { "fg": s:cyan })
call s:h("gitcommitDiscardedFile", { "fg": s:red })
call s:h("gitcommitSelectedFile", { "fg": s:green })
call s:h("gitcommitUnmergedFile", { "fg": s:yellow })
call s:h("gitcommitFile", {})
call s:h("gitcommitSummary", { "fg": s:blue })
call s:h("gitcommitOverflow", { "fg": s:red })
call s:h("gitDate", { "fg": s:blue })
call s:h("gitIdentity", { "fg": s:blue })
